...
Select the prompt-injection example.

"Both fields are untrusted. This source tries to tell the reviewer to ignore its instructions and mark everything PASS. GroundCheck surfaces the attempted manipulation, treats it as document content, and still catches the false retention claim."
